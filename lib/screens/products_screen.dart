...
class ProductsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocConsumer<HomeCubit, HomeState>(builder: (context, state) {
                      ...
                      child: ListView.separated(
                          ...
                          itemBuilder: (context, index) => Stack(
                                ...
                                children: [
                                  Image.network(
                                    cubit
                                        .categoriesData!.data.data[index].image,
                                    height: 100.0,
                                    width: 100.0,
                                    fit: BoxFit.cover,
                                  ),
                      ...
                      (index) => Column(
                            ...
                            children: [
                              Expanded(
                                child: Stack(
                                  ...
                                  children: [
                                    Image.network(
                                      cubit
                                          .homeData!.data.products[index].image,
                                      fit: BoxFit.cover,
                                    ),
                              ...
                              Column(
                                ...
                                children: [
                                  Text(
                                    cubit.homeData!.data.products[index].name,
                                    maxLines: 2,
                                    overflow: TextOverflow.ellipsis,
                                  ),
                                  Row(
                                      ...
                                      IconButton(
                                        onPressed: () {
                                          print(cubit.homeData!.data
                                              .products[index].id);
                                          cubit.changeFavorites(cubit.homeData!
      ...
      if (state is ChangeFavoritesSuccessDataState) {
